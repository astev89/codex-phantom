...
export class EmailChannelService {
  ...
  private readonly responseDispatcher: InboundResponseDispatcher;
  ...
  constructor(input: {
    ...
    responseDispatcher: InboundResponseDispatcher;
    ...
    this.responseDispatcher = input.responseDispatcher;
